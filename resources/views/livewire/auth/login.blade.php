...
<div>
    <div class="sm:mx-auto sm:min-w-full sm:max-w-md">
       
        <h1 class="mt-6 text-3xl font-extrabold text-center text-gray-900 leading-9">BIGSCREEN</h1>
        <h2 class="mt-6 text-3xl  text-center text-gray-900 leading-9">
